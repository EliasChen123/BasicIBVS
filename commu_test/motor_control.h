...
public:
    ...
    float vel_protection_level = 5;
    float tau_protection_level = 0;

    float m_desir_motor_pos_protect_max[MOTOR_NUM] = { 1.5,  1.45,  2.30};
    float m_desir_motor_pos_protect_min[MOTOR_NUM] = {-1.5, -0.22, -0.3};

    float desir_motor_vel_protect_max[MOTOR_NUM] = { 1.57,  2.57,  2.57};
    float desir_motor_vel_protect_min[MOTOR_NUM] = {-1.57, -2.57, -2.57};

    // float desir_motor_tau_protect_max[MOTOR_NUM] = { 2,  3,  3};
    // float desir_motor_tau_protect_min[MOTOR_NUM] = {-2, -3, -3};
    ...
    float current_motor_vel_protect_max[MOTOR_NUM] = { 2.07,  2.07,  1.57};
    float current_motor_vel_protect_min[MOTOR_NUM] = {-1.57, -1.57, -1.07};
    ...
    // float static_friction_in_gravity_max[MOTOR_NUM] = { 0.08,  0.2,   0.08};
    // float static_friction_in_gravity_min[MOTOR_NUM] = {-0.08, -0.04, -0.07};
    ...
    void ControlMotors(serialport::SerialPortWrapper &port);

    void updatMotorState(std::vector<float> motorState);
    void real_time_motor_protection(float vel_[MOTOR_NUM], float tau_[MOTOR_NUM], serialport::SerialPortWrapper &port);
